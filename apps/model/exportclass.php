...
class Model_ExportClass
{
		...
		public function dostats( )
		{
				...
				$objPHPExcel = $this->objPHPExcel;
				$objPHPExcel->setactivesheetindex( 0 )->setcellvalue( "A1", iconv( "gb2312", "utf-8", "����" ) )->setcellvalue( "B1", iconv( "gb2312", "utf-8", "�����Ŀ" ) )->setcellvalue( "C1", iconv( "gb2312", "utf-8", "�����" ) )->setcellvalue( "D1", iconv( "gb2312", "utf-8", "������" ) );
				if ( $type == "a" )
				{
