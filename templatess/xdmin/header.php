...
if ( in_array( $action,array( "affiliate","advertiser","affiliate","service","commercial") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
if ( in_array( $action,array( "plan","createplan","editplan","cpcplan","cpmplan","cpaplan","cpsplan","cpvplan","planaudit") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
if ( in_array( $action,array( "ads","createads","editads","adstype","upadslog") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
echo DAYS."/".DAYS;
echo "\"  ";
if ( in_array( $action,array( "stats","statsads","statsuser","statszone","adsip","trend","import") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
if ( in_array( $action,array( "site","zone") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
if ( in_array( $action,array( "pm","news","administrator","sitetype","help","loginlog","adminlog","db") ) )
{
echo " class=\"action\"";
}
echo "> <img src=\"/templates/";
...
if ( in_array( $_GET['action'],array( "setting") ) )
{
...
if ( in_array( $_GET['action'],array( "affiliate","advertiser","service","commercial","createuser") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"";
if ( $action == "affiliate")
{
...
if ( in_array( $_GET['action'],array( "plan","cpcplan","cpmplan","cpaplan","cpsplan","cpvplan","planaudit") ) )
{
if ( !$plantypearr )
{
...
if ( in_array( $_GET['action'],array( "ads","adstype","upadslog","cpcads","cpmads","cpaads","cpsads","cpvads") ) )
{
if ( !$plantypearr )
{
$adstypemodel = Z::getsingleton( "model_adstypeclass");
...
if ( in_array( $_GET['action'],array( "stats","statsuser","statsads","statszone","adsip","trend","orders","import","scancheat") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"";
if ( $action == "stats")
{
...
echo "\"> <a   href=\"dos.php?action=trend\"><span>流量概况</span></a> </li>\r\n                    <li class=\"";
if ( $action == "scan")
{
echo "active";
}
...
if ( in_array( $_GET['action'],array( "site","zone") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"";
if ( $action == "site")
{
...
if ( in_array( $_GET['action'],array( "pm","news","sitetype","help","loginlog","administrator","adminlog","db") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"";
if ( $action == "pm")
{
...
if ( in_array( $_GET['action'],array( "pay","onlinepay") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"";
if ( $action == "pay")
{
...
if ( in_array( $_GET['action'],array( "email") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"active\"> <a   href=\"do.php?action=email\"><span>发送邮件</span></a> </li>\r\n                  </ul>\r\n                </div>\r\n              </div>\r\n            </div></td>\r\n        </tr>\r\n      </table></td>\r\n  </tr>\r\n</table>\r\n";
}
echo "\r\n";
if ( in_array( $_GET['action'],array( "scan") ) )
{
echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >\r\n  <tr>\r\n    <td><table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n        <tr>\r\n          <td><div id=\"page-header\">\r\n              <div class=\"limiter clear-block\">\r\n                <div id=\"page-tools\"> </div>\r\n                <div class=\"tabs\">\r\n                  <ul class=\"links\">\r\n                    <li class=\"active\"> <a   href=\"do.php?action=scan\"><span>云端扫描作弊</span></a> </li>\r\n                  </ul>\r\n                </div>\r\n              </div>\r\n            </div></td>\r\n        </tr>\r\n      </table></td>\r\n  </tr>\r\n</table>\r\n";
}
?>